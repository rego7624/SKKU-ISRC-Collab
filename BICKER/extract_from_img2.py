...
def plot_lm(target, landmarks):
    ...
    ax.axis('off')
    ax.imshow(np.ones(target.shape))
    ...
    #ax.plot([landmarks[41, 0], landmarks[36, 0]], [landmarks[41, 1], landmarks[36, 1]], linestyle='-', color='blue', lw=2)
    
    ax.plot(landmarks[42:48, 0], landmarks[42:48, 1], linestyle='-', color='red', lw=2)
    #ax.plot([landmarks[47, 0], landmarks[42, 0]], [landmarks[47, 1], landmarks[42, 1]], linestyle='-', color='blue', lw=2)
